...
- it is able to merge Differencing VHDs and expand inplace Dynamic ones.
...
- to list contents in a disk or disk image, copy items to/from it (even between different disk images), display and erase them:
```
